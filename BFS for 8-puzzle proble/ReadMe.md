...
In this program, I am using Breadth First Search to solve this problem.
...
**For example:**
ananyabanerjee@Ananyas-MacBook-Pro Desktop % python3 bfs_.py bfs
